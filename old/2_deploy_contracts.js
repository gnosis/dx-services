...
This file is a copy paste of:
  ../node_modules/@gnosis.pm/dutch-exchange/migrations/2_deploy_contracts

Tried to avoid dupplication but it looks that truffle relies on a global
'atifact' variable.

Nice if someone knows how to make it work! :)
  const deployContractsFn = require('../node_modules/@gnosis.pm/dutch-exchange/migrations/2_deploy_contracts')
