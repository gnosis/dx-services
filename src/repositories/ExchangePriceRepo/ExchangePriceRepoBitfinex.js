const debug = require('debug')('DEBUG-dx-service:repositories:ExchangePriceRepoBitfinex')
const httpRequest = require('../../helpers/httpRequest')
const Cache = require('../../helpers/Cache')
const CACHE_SYMBOLS_KEY = 'ExchangePriceRepoBitfinex:'
const CACHE_SYMBOLS_TIME = 2 * 60 * 60 * 1000 // 2 hours

class ExchangePriceRepoBitfinex {
  constructor ({ url = 'https://api.bitfinex.com', version = 'v1', timeout = 5000 }) {
    this._timeout = timeout
    this._version = version
    this._baseUrl = url
    this._cache = new Cache('ExchangePriceRepoBitfinex')
  }
...
module.exports = ExchangePriceRepoBitfinex
