const ExchangePriceRepoBinance = require('../../../src/repositories/ExchangePriceRepo/ExchangePriceRepoBinance')
const exchangePriceRepo = new ExchangePriceRepoBinance({})
...
test('It should throw an error for unknown Crypto markets', async () => {
  ...
  try {
    ...
    expect(e).toEqual(new Error('No matching markets in Binance: XBT-OMG'))
  }
})
